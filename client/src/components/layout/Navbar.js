...
const Navbar = () => {
    return (
        <nav className="navbar navbar-expand navbar-dark bg-dark">
            ...
            <Link className='btn btn-outline-light' to='/adminDashboard/addTeacher'>Add Teacher</Link>
            <Link className='btn btn-outline-light' to='/adminDashboard/addStudent'>Add Student</Link>
        </div>
        </nav>
    );
};
